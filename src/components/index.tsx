...
export {default as LegendaryComponent}  from "./LegendaryComponent"; 
export {default as ProfitShowerComponent}  from "./ProfitShowerComponent"; 
export {default as DailyItemsComponent}  from "./DailyItemsComponent"; 
